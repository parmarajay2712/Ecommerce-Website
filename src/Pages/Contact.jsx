...
const Contact = () => {
  return (
    // Outer container div for the full screen contact section
    // - Uses Tailwind CSS classes for minimum screen height, background gradient, flex centering, and padding
    <div className="min-h-screen bg-linear-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] flex items-center justify-center px-4 py-10">
      {/* Inner container with blur effect, semi-transparent background, border, rounded corners, shadow, padding */}
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        ...
        <h2 className="text-4xl font-bold text-white text-center mb-10">
          Get in Touch with <span className="text-red-400">Ecommerce</span>
        </h2>

        {/* Grid layout for info and form sections */}
...
// Exporting the Contact component as default for use in other files
